...
{
  // Extend the HostFactory with app-specific bits
  public static IHost Build(HostApplicationBuilder b, ParseResult parseResult)
  {
    // Perform additional Builder configuration

    // Override connection string with the global cli option
    var connectionString = parseResult.GetValue<string>("--connection-string");
